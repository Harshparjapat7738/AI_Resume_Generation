 ...
 *
 * <p>resume-service calls profile-service and jd-service directly (Eureka, not through the
 * gateway), so those services never see the gateway's own header-stripping/re-setting step.
