...
export function Security() {
  return (
    <section id="security" className="scroll-mt-20 border-t border-border bg-void py-24">
      <div className="mx-auto max-w-6xl px-6">
        <Reveal className="max-w-2xl">
          <p className="text-sm font-medium uppercase tracking-wide text-ember-soft">Security</p>
          ...
          <p className="mt-4 text-lg leading-relaxed text-ink-muted">
            ...
            stored, reached and shared — which is to say, never further than it has to be.
          </p>
        </Reveal>
          ...
          {securityPoints.map((point, i) => {
            ...
            return (
              <div key={point.title} className="rounded-2xl border border-border bg-surface p-6">
                <span className="flex h-10 w-10 items-center justify-center rounded-xl bg-surface-2 text-mint ring-1 ring-border-strong">
